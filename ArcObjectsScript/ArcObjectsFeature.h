// ArcObjectsFeature.h : Declaration of the CArcObjectsFeature
...
class ATL_NO_VTABLE CArcObjectsFeature :
...
DECLARE_REGISTRY_RESOURCEID(IDR_ARCOBJECTSFEATURE)


BEGIN_COM_MAP(CArcObjectsFeature)
	COM_INTERFACE_ENTRY(IArcObjectsFeature)
...
OBJECT_ENTRY_AUTO(__uuidof(ArcObjectsFeature), CArcObjectsFeature)
