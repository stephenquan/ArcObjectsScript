// ArcObjectsSpatialReference.h : Declaration of the CArcObjectsSpatialReference
...
OBJECT_ENTRY_AUTO(__uuidof(ArcObjectsSpatialReference), CArcObjectsSpatialReference)
